...
public interface ErrorCodeConstants {
    ...
    // ========== 打赏模块 1-007-010-000 ==========
    ErrorCode REWARD_AMOUNT_INVALID = new ErrorCode(1_007_010_000, "打赏金额必须在0.01元到99.99元之间");
    ErrorCode REWARD_SELF_NOT_ALLOWED = new ErrorCode(1_007_010_001, "不能打赏自己");
    ErrorCode REWARD_ORDER_NOT_FOUND = new ErrorCode(1_007_010_002, "打赏订单不存在");

    // ========== 提现模块 1-007-011-000 ==========
    ErrorCode WITHDRAW_AMOUNT_INVALID = new ErrorCode(1_007_011_000, "提现金额无效");
    ErrorCode WITHDRAW_ORDER_NOT_FOUND = new ErrorCode(1_007_011_001, "提现订单不存在");
    ErrorCode WITHDRAW_AMOUNT_TOO_LOW = new ErrorCode(1_007_011_002, "提现金额低于最低限制");
    ErrorCode WITHDRAW_DAILY_LIMIT_EXCEEDED = new ErrorCode(1_007_011_003, "今日提现次数已达上限");
    ErrorCode WITHDRAW_IN_PROGRESS_EXISTS = new ErrorCode(1_007_011_004, "存在处理中提现订单，请稍后再试");
    ErrorCode WITHDRAW_ORDER_NOT_BELONG_TO_USER = new ErrorCode(1_007_011_005, "提现订单不属于当前用户");
    ErrorCode WITHDRAW_CANNOT_CANCEL = new ErrorCode(1_007_011_006, "提现订单当前状态不可取消");
    ErrorCode WITHDRAW_ALREADY_AUDITED = new ErrorCode(1_007_011_007, "提现订单已完成审核");
    ErrorCode WITHDRAW_STATUS_INVALID = new ErrorCode(1_007_011_008, "提现订单状态不支持当前操作");
