...
public interface MemberUserApi {
    ...
    @GetMapping(PREFIX + "/get-by-custom-id")
    @Operation(summary = "基于 custom_id 精确匹配用户")
    @Parameter(name = "custom_id", description = "自定义用户ID", required = true, example = "10001234")
    CommonResult<MemberUserRespDTO> getUserByCustomId(@RequestParam("custom_id") Long customId);
