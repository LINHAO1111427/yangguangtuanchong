...
public interface ErrorCodeConstants {
    ...
    ErrorCode FILE_STORAGE_NOT_SUPPORT_MULTIPART = new ErrorCode(1_001_003_003, "当前文件存储未开启分片上传，请检查配置");
    ...
    ErrorCode CODEGEN_TABLE_INFO_COLUMN_COMMENT_IS_NULL = new ErrorCode(1_001_004_009, "数据库的表字段注释未填写");
    ...
    ErrorCode DEMO02_CATEGORY_EXITS_CHILDREN = new ErrorCode(1_001_201_002, "存在子示例分类，无法删除");
