...
public interface FileService {
     ...
     * 分片上传初始化
     */
    MultipartUploadInitRespVO initMultipartUpload(MultipartUploadInitReqVO reqVO);

    /**
     * 获取单个分片的预签名 URL
     */
    MultipartUploadPartUrlRespVO getMultipartUploadPartUrl(MultipartUploadPartUrlReqVO reqVO);

    /**
     * 完成分片上传
     */
    void completeMultipartUpload(MultipartUploadCompleteReqVO reqVO);
